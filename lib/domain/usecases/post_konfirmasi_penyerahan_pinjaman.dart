...
class PostKonfirmasiPenyerahanPinjamanUseCase {
  final TransaksiRepository _transaksiRepository;
  const PostKonfirmasiPenyerahanPinjamanUseCase(this._transaksiRepository);

  Future<Either<String, GeneralResponse>> call({
    required Map<String, dynamic> payload,
  }) =>
      _transaksiRepository.postKonfirmasiPenyerahanKonfirmasPinjamanCND(
        payload,
      );
}
