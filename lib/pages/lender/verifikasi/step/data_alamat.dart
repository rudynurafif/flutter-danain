...
class StepDataAlamat extends StatefulWidget {
  final VerifikasiBloc verifBloc;
  const StepDataAlamat({
    super.key,
    required this.verifBloc,
  });

  @override
  State<StepDataAlamat> createState() => _StepDataAlamatState();
}

class _StepDataAlamatState extends State<StepDataAlamat> {
  ...
  Widget formAlamat(VerifikasiBloc bloc) {
    return StreamBuilder<String?>(
      stream: widget.verifBloc.alamatErrorStream,
      builder: (context, snapshot) {
        return Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget provinsiForm(VerifikasiBloc bloc) {
  ...
  Widget kotaForm(VerifikasiBloc bloc) {
    return StreamBuilder<List<dynamic>>(
  ...
  Widget formKecamatan(VerifikasiBloc bloc) {
    return StreamBuilder<String?>(
      stream: widget.verifBloc.kecamatanError,
      builder: (context, snapshot) {
        return Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget formKelurahan(VerifikasiBloc bloc) {
    return StreamBuilder<String?>(
      stream: widget.verifBloc.kelurahanError,
      builder: (context, snapshot) {
        return Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget formKodePos(VerifikasiBloc bloc) {
    return StreamBuilder<String?>(
      stream: widget.verifBloc.kodePosError,
      builder: (context, snapshot) {
        return Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
