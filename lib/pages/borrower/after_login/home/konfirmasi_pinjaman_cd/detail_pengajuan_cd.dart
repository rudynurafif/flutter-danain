...
class DetailPengajuanCDPage extends StatelessWidget {
  static const routeName = '/detail_pengajuan_c&d';
  const DetailPengajuanCDPage({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            const LokasiComponent(
              alamatUtama: "Bendungan Jago No 28 RT19/RW03, Serdang, Kemayoran, Jakarata Pusat",
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        ...
        const Flexible(
          child: Subtitle3(
            text: 'Pastikan Anda berada di lokasi sesuai dengan jadwal yang telah ditentukan ',
