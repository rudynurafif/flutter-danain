...
class KonfirmasiPincamanCdBloc extends DisposeCallbackBaseBloc {
  ...
  factory KonfirmasiPincamanCdBloc(
    ...
    void getPinjaman(int idPengajuan) async {
      final event = await authState.first;
      final token = event.orNull()!.userAndToken!.token.toString();
      ...
      try {
        final response =
            await apiService.getDetailKonfirmasiPinjaman(token, idPengajuan);
    ...
    return KonfirmasiPincamanCdBloc._(
