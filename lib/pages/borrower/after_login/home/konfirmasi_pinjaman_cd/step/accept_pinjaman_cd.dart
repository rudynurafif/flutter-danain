...
class AcceptPinjamanCd extends StatefulWidget {
  final KonfirmasiPincamanCdBloc ppBloc;
  const AcceptPinjamanCd({super.key, required this.ppBloc});

  @override
  State<AcceptPinjamanCd> createState() => _AcceptPinjamanState();
}

class _AcceptPinjamanState extends State<AcceptPinjamanCd> {
