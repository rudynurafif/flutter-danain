...
class OtpPrivyPinjamanCd extends StatefulWidget {
  final KonfirmasiPincamanCdBloc ppBloc;
  const OtpPrivyPinjamanCd({super.key, required this.ppBloc});

  @override
  State<OtpPrivyPinjamanCd> createState() => _OtpPrivyPinjamanState();
}

class _OtpPrivyPinjamanState extends State<OtpPrivyPinjamanCd> {
  String? otpCode;
  bool otpValid = false;
  ...
  Widget subVerif(KonfirmasiPincamanCdBloc bloc) {
  ...
  Widget otpText(KonfirmasiPincamanCdBloc bloc) {
    return StreamBuilder<String?>(
  ...
  Widget actionButton(KonfirmasiPincamanCdBloc bloc) {
