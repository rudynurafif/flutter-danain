...
class PenawaranPinjamanDetail extends StatefulWidget {
  final PenawaranPinjamanBloc2 ppBloc;
  const PenawaranPinjamanDetail({super.key, required this.ppBloc});

  @override
  State<PenawaranPinjamanDetail> createState() =>
      _PenawaranPinjamanDetailState();
}

class _PenawaranPinjamanDetailState extends State<PenawaranPinjamanDetail> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget agreeCheckBox(PenawaranPinjamanBloc2 bloc) {
    return Padding(
  ...
  Widget buttonAgree(PenawaranPinjamanBloc2 bloc) {
    return Padding(
...
class SyaratKetentuan extends StatefulWidget {
  final PenawaranPinjamanBloc2 bloc;
