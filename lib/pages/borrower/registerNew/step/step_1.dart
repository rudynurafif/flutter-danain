...
import 'package:flutter_danain/pages/borrower/registerNew/step/syarat_ketentuan_screen.dart';
import 'package:flutter_danain/widgets/widget_element.dart';
import 'package:hexcolor/hexcolor.dart';

class Step1RegisBorrower extends StatefulWidget {
  final RegisterNewBloc regisBloc;
  const Step1RegisBorrower({super.key, required this.regisBloc});

  @override
  State<Step1RegisBorrower> createState() => _Step1RegisBorrowerState();
}

class _Step1RegisBorrowerState extends State<Step1RegisBorrower> {
  TextEditingController nameController = TextEditingController();
  TextEditingController emailController = TextEditingController();
  TextEditingController phoneController = TextEditingController();
  TextEditingController kodeController = TextEditingController();

  bool haveAgree = false;
  ...
  Widget nameForm(RegisterNewBloc bloc) {
              ...
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle:
                    TextStyle( fontFamily: 'Poppins',color: HexColor('#BEBEBE'), fontSize: 14),
                    alignLabelWithHint: true,
                    border: const OutlineInputBorder(),
                    errorText: snapshot.data != null ? '' : null,
                    enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: HexColor('#DDDDDD'))),
                    focusedBorder: const OutlineInputBorder( // Set the focused border color
                      borderSide: BorderSide(color: Color(0xFF27AE60)), // Change to the desired blue color
                    ),
                  ),
                ),
                if (snapshot.hasData)
  ...
  Widget emailForm(RegisterNewBloc bloc) {
    return StreamBuilder<String?>(
  ...
  Widget phoneForm(RegisterNewBloc bloc) {
    return StreamBuilder<String?>(
  ...
  Widget kodeForm(RegisterNewBloc bloc) {
    return StreamBuilder<String?>(
  ...
  Widget checkForm(RegisterNewBloc bloc) {
          ...
          onTap: () {
            if (data == true) {
              ...
              showModalBottomSheet(
                ...
                useSafeArea: true,
                builder: (context) => SyaratDanKetentuanBorrower(
                  bloc: bloc,
                  haveAgree: haveAgree,
                ),
              );
