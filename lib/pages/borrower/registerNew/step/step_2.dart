...
import '../registerNew_bloc.dart';

class Step2RegisBorrower extends StatefulWidget {
  final RegisterNewBloc regisBloc;
  const Step2RegisBorrower({super.key, required this.regisBloc});

  @override
  State<Step2RegisBorrower> createState() => _Step2RegisBorrowerState();
}

class _Step2RegisBorrowerState extends State<Step2RegisBorrower> {
  String? otpCode;
  bool otpValid = false;
  ...
  Widget subVerif(RegisterNewBloc rgBloc) {
    return Text.rich(
