...
private extension String {
  static let CRYPTO_CHANNEL = "com.hoc.flutter_danain/crypto"
  static let CRYPTO_ERROR_CODE = "com.hoc.flutter_danain/crypto_error"
...
@objc class AppDelegate: FlutterAppDelegate {
  override func application(
    ...
    OneSignal.setAppId("8118d655-fcbc-40e6-89a5-9f7521d0f40d")
...
private func useAES(
  ...
  guard let inputBytes = inputToBytes(input) else {
    NSLog("\n[FLUTTER_DANAIN] Error: inputToBytes returns nil")
  ...
  AESConfig.backgroundQueue.async {
    ...
    do {
      ...
      guard let stringResult = bytesToString(outputBytes) else {
        NSLog("\n[FLUTTER_DANAIN] Error: bytesToString returns nil")
      ...
      NSLog("\n[FLUTTER_DANAIN] Time: \(millisTime) ms")
